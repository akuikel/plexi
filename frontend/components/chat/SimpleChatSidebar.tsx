...
import { MessageCircle, Plus, MoreVertical, Trash2, Edit, Clock } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { Chat } from '@/hooks/chat/useSimpleChat';
...
/**
 * Simplified chat sidebar without message counts
 */
                  ...
                  {editingChatId === chat.id ? (
                    ...
                    <>
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-sm font-medium line-clamp-1 flex-1">{getChatTitle(chat)}</h3>
