          ...
          <div className="space-y-3 pr-4">
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>Start a conversation with Persa AI</p>
              </div>
            ) : (
              messages.map((message) => (
                <div key={message.id} className={cn('flex', message.role === 'USER' ? 'justify-end' : 'justify-start')}>
                  ...
                  >
                    <div className="text-sm font-medium mb-1">{message.role === 'USER' ? 'You' : 'Persa AI'}</div>
              ...
              <div className="flex justify-start">
                <div className="bg-muted border-2 border-dashed border-primary/50 rounded-lg p-3 max-w-[80%]">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground italic">Persa is processing your request...</span>
                  </div>
                </div>
              </div>
            )}
